// $ANTLR 3.4 Velvet.g 2015-08-14 10:20:56
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final VelvetParser.concept_return concept() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: interfaceImports, CONCEPT, definitions, conceptBaseExt, ID, instanceImports
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final VelvetParser.cinterface_return cinterface() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: definitions, ID, CINTERFACE, conceptBaseExt
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final VelvetParser.interfaceImports_return interfaceImports() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: IMPORTINTERFACE, ID, name
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final VelvetParser.feature_return feature() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: ABSTRACT, FEATURE, definitions, MANDATORY, name
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
